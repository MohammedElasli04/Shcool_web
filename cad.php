...
<head>
    ...
    <title>CAD et Activités parascolaires</title>
...
<body>
    ...
    <div class="cnt-b">
        ...
        <div class="cnt-ch2">
            <div class="cnt-t">
                <h1 style="text-align: center;">Les Activites parashcolaire</h1><br>
                <p>
                    Les activités parascolaires jouent un rôle essentiel dans le développement global des stagiaires.
                    ...
                    nous préparons nos stagiaires à devenir des individus confiants et engagés, prêts à relever les défis de demain
                </p>
            </div>
        </div>
    </div>
